<nav class="flex items-center justify-between bg-gray-100 px-6 py-2 text-black">
    <div class="flex items-center space-x-8">
        <button
            ...
            class="text-gray-700 hover:cursor-pointer hover:text-gray-800"
        >
            <i class="fas fa-bars"></i>
        </button>
        <nav class="flex space-x-4">
            <a
                wire:navigate.hover="/dashboard"
            ...
            <a
                wire:navigate.hover="/contact_me"
                href="{{ route("show.contact-me.page") }}"
                class="text-gray-600 hover:text-gray-800"
            >
                Contact
            </a>
    ...
    <div class="flex items-center space-x-4">
        ...
        >
            <i class="fas fa-moon text-lg text-black"></i>
        </button>
        ...
        <div class="group relative">
            ...
            >
                <div class="p-2">
                    <a
                        href=""
                        class="block rounded-t-lg px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"
                    >
                        <i class="fas fa-user mr-2"></i>
                        Profile
                    </a>
                    <a
                        wire:navigate="/logout"
